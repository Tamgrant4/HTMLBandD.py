...
<body>
  ...
  <p>These chewy and delicious cookies are a timeless treat. Packed with semisweet chocolate chips and optional chopped nuts, they're perfect for any occasion.</p>
  ...
  <ol>
    ...
    <li>Line baking sheets with parchment paper or silicone baking mats.</li>
...
<body>
    <h1>Classic Chocolate Chip Cookies</h1>
    <p>These classic chocolate chip cookies are soft, chewy, and loaded with chocolate chips. Perfect for satisfying your sweet tooth!</p>
    
    <p>For the full recipe, visit the <a href="https://www.ghirardelli.com/recipes/classic-chocolate-chip-cookies-rec1016" target="_blank">Ghirardelli Classic Chocolate Chip Cookies Recipe</a>.</p>
...
<body>
    <h1>Classic Chocolate Chip Cookies</h1>
    <p>These classic chocolate chip cookies are soft, chewy, and loaded with chocolate chips. Perfect for satisfying your sweet tooth! 
    You can find the original recipe <a href="https://www.ghirardelli.com/recipes/classic-chocolate-chip-cookies-rec1016" target="_blank">here</a>.</p>
    ...
    <h2>Image</h2>
    <img src= https://www.ghirardelli.com/recipes/classic-chocolate-chip-cookies-rec1016. " width="500">
</body>
</html>
...
<body>
    ...
    <h2>Image</h2>
    <img src="https://www.example.com/chocolate-chip-cookies.jpg" alt="Yummy chocolate chip cookies" width="500">
...
<body>
    <!-- Task 1: Adding the title and description of the recipe -->
    <h1>Classic Chocolate Chip Cookies</h1>
    <p>These classic chocolate chip cookies are soft, chewy, and loaded with chocolate chips. Perfect for satisfying your sweet tooth! 
    <!-- Adding a hyperlink to the original recipe URL -->
    You can find the original recipe <a href="https://www.ghirardelli.com/recipes/classic-chocolate-chip-cookies-rec1016" target="_blank">here</a>.</p>
    
    <!-- Task 1: Adding the ingredients as an unordered list -->
    <h2>Ingredients</h2>
    <ul>
        <li>1 cup (2 sticks) unsalted butter, softened</li>
        <li>3/4 cup granulated sugar</li>
    ...
    <!-- Task 1: Adding the steps as an ordered list -->
    <h2>Steps</h2>
    <ol>
        <li>Preheat the oven to 375°F (190°C). Line baking sheets with parchment paper or silicone baking mats.</li>
        <li>In a large mixing bowl, cream together the softened butter, granulated sugar, brown sugar, and vanilla extract until light and fluffy.</li>
    ...
    <!-- Task 2: Inserting an image of chocolate chip cookies -->
    <h2>Image</h2>
    <img src="https://www.example.com/chocolate-chip-cookies.jpg" alt="Yummy chocolate chip cookies" width="500">

    <!-- Task 3: Adding a paragraph with a special character (ndash) -->
    <p>Don't forget to enjoy your Classic Chocolate Chip Cookies with a tall glass of milk &ndash; the perfect combination!</p>
</body>
</html>
